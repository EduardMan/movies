...
public enum ImportCsvSqlQuery {
    ...
    PRODUCTION_COUNTRY_INSERT("INSERT INTO production_countries(iso_3166_1, name) VALUES (?, ?) ON CONFLICT DO NOTHING"),
    SPOKEN_LANGUAGE_INSERT("INSERT INTO spoken_language(iso_639_1, name) VALUES (?, ?) ON CONFLICT DO NOTHING"),

    MOVIE_COLLECTION_INSERT("INSERT INTO movie_collection (movie_id, collection_id) VALUES (?, ?)"),
    MOVIE_GENRE_INSERT("INSERT INTO movie_genre (movie_id, genre_id) VALUES (?, ?)"),
    MOVIE_PRODUCTION_COMPANY_INSERT("INSERT INTO movie_production_company (movie_id, production_company_id) VALUES (?, ?)"),
    MOVIE_PRODUCTION_COUNTRY_INSERT("INSERT INTO movie_production_countries (movie_id, production_countries_id) VALUES (?, ?)"),
    MOVIE_SPOKEN_LANGUAGE_INSERT("INSERT INTO movie_spoken_languages (movie_id, spoken_language_id) VALUES (?, ?)");
